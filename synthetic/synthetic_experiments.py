...
if __name__ == "__main__":
    ...
    print("VaDE:", compute_purity_average(mean.detach().numpy(), cla, 8, 1024, 100))
    print("PCA:", compute_purity_average(projection, cla, 8, 1024, 100))
    print("Origin:", compute_purity_average(synthetic_data, cla, 8, 1024, 100))
